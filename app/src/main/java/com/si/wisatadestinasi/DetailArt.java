...
public class DetailArt extends AppCompatActivity {
    ...
    public Activity activity = DetailArt.this;
    ...
    public void setData(){
        api.getDataVolley(routes.getArt + getIntent().getStringExtra("id"), activity, new VolleyResponseListener() {

            @Override
            public void onResponse(String response) {
                try {
                    JSONObject result = new JSONObject(response);
                    TextView tvWilayah, tvJenis, tvAlamat, tvRating, tvOrang;
                    String wilayah, jenis,  alamat, rating, orang;
                    ...
                    tvJenis  = findViewById(R.id.jenis_kesenian);
                    ...
                    jenis     = result.getString("jenis_kesenian");
                    ...
                    ToolClass.btnListener(activity, "art", id);
                    ToolClass.imgListener(activity, routes.gambarArt + foto);
                    ToolClass.initWebView(activity, "art", id);

                    Glide.with(activity).load(routes.gambarArt + foto).fitCenter().into(ivFoto);
