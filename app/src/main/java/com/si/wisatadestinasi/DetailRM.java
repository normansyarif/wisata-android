...
public class DetailRM extends AppCompatActivity {
    ...
    public Activity activity = DetailRM.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_r_m);
    ...
    public void setData(){
        api.getDataVolley(routes.getRM + getIntent().getStringExtra("id"), activity, new VolleyResponseListener() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    ToolClass.btnListener(activity, "rm", id);
                    ToolClass.imgListener(activity, routes.gambarRM + foto);
                    ToolClass.initWebView(activity, "rm", id);

                    Glide.with(activity).load(routes.gambarRM + foto).fitCenter().into(ivFoto);
