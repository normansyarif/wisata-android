...
public class DetailUMKM extends AppCompatActivity {
    ...
    public Activity activity = DetailUMKM.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_u_m_k_m);
    ...
    public void setData(){
        api.getDataVolley(routes.getUMKM + getIntent().getStringExtra("id"), activity, new VolleyResponseListener() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    ToolClass.btnListener(activity, "umkm", id);
                    ToolClass.imgListener(activity, routes.gambarUMKM + foto);
                    ToolClass.initWebView(activity, "umkm", id);

                    Glide.with(activity).load(routes.gambarUMKM + foto).fitCenter().into(ivFoto);
