...
public class DetailSouvenir extends AppCompatActivity {
    ...
    public Activity activity = DetailSouvenir.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_souvenir);
    ...
    public void setData(){
        api.getDataVolley(routes.getSouvenir + getIntent().getStringExtra("id"), activity, new VolleyResponseListener() {

            @Override
            public void onResponse(String response) {
                try {
                    JSONObject result = new JSONObject(response);
                    TextView tvWilayah, tvHarga, tvAlamat, tvRating, tvOrang;
                    String wilayah, harga,  alamat, rating, orang;
                    ...
                    ToolClass.btnListener(activity, "souvenir", id);
                    ToolClass.imgListener(activity, routes.gambarSouvenir + foto);
                    ToolClass.initWebView(activity, "souvenir", id);

                    Glide.with(activity).load(routes.gambarSouvenir + foto).fitCenter().into(ivFoto);
