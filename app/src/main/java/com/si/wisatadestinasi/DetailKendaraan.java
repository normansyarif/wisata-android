...
public class DetailKendaraan extends AppCompatActivity {
    ...
    public Activity activity = DetailKendaraan.this;
    ...
    public void setData(){
        api.getDataVolley(routes.getKendaraan + getIntent().getStringExtra("id"), activity, new VolleyResponseListener() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    ToolClass.btnListener(activity, "kendaraan", id);
                    ToolClass.imgListener(activity, routes.gambarKendaraan + foto);
                    ToolClass.initWebView(activity, "kendaraan", id);

                    Glide.with(activity).load(routes.gambarKendaraan + foto).fitCenter().into(ivFoto);
